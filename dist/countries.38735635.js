...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"apps.js":[function(require,module,exports) {
"use strict";
...
},{}],"Languages feature/countries.js":[function(require,module,exports) {
"use strict";
...
var currentLanguageBtn = document.querySelector('.current-language-btn');
var languageModalOverlay = document.querySelector('.language-modal-overlay');
var closeLangBtn = document.querySelector('.close-language-btn');
var menuTitle = document.querySelector('.title h2');
var translateItems = document.getElementsByClassName('translate');

var languagesOptions = function languagesOptions() {
  var languages = [];

  for (var countryCode in countries) {
    if (countryCode == 'en') {
      languages.push("<button class=\"language-btn\">\n                                <span class=\"fi fi-gb\"></span>\n                                <span>".concat(countries[countryCode], "</span>\n                            </button>"));
    } else if (countryCode == 'ja') {
      languages.push("<button class=\"language-btn\">\n                                <span class=\"fi fi-jp\"></span>\n                                <span>".concat(countries[countryCode], "</span>\n                            </button>"));
    } else {
      languages.push("<button class=\"language-btn\">\n                                <span class=\"fi fi-".concat(countryCode, "\"></span>\n                                <span>").concat(countries[countryCode], "</span>\n                             </button>"));
    }
  }
...
currentLanguageBtn.addEventListener('click', function () {
  ...
  menuTraslated();
  setTimeout(function () {
    (0, _apps.displayMenuItems)(_apps.menu);
  }, 1000);
  setTimeout(function () {
    (0, _apps.displayBtns)(_apps.menu);
  }, 1000);
});
...
var translation = function translation(item) {
  var options = {
    method: 'POST',
    ...
    data: "[{\"Text\":\"".concat(item.textContent, "\"}]")
  };
...
var translationAll = function translationAll(item) {
  var options = {
    method: 'POST',
    url: 'https://microsoft-translator-text.p.rapidapi.com/translate',
    params: {
...
var menuTranslations = function menuTranslations(menu, data) {
  return menu.map(function (items) {
    var options = {
      method: 'POST',
      url: 'https://microsoft-translator-text.p.rapidapi.com/translate',
      params: {
...
var menuTraslated = function menuTraslated() {
  menuTranslations(_apps.menu, 'title');
  menuTranslations(_apps.menu, 'category');
  menuTranslations(_apps.menu, 'desc');
};
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js","../apps":"apps.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Languages feature/countries.js"], null)
//# sourceMappingURL=/countries.38735635.js.map